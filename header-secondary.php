...
<html>
    ...
    <body <?php if (in_category(9, $wp_query->get_queried_object_id()) || is_category(9)) echo 'class="on-portfolio-page"'; ?>>
        <section id="header" class="header-secondary-page">
                          ...
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <form id="myForm" role="form" data-toggle="validator" class="garik-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="phone" class="form-control" placeholder="970 111 11 11"  required />
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                </div>
                                <div class="form-group">
                                    <p>Your Comment</p>
